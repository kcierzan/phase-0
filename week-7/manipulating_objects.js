...
// I had a bit of trouble adding carson because I was trying to define carson as a variable and add that variable as a value for the children property rather than to the children object. I realized that I needed the syntax for adding an object to an object instead.
//
//How difficult was it to add and delete properties outside of the object itself?

//Adding a deleting properties from outside the object was a bit challenging but once I became more concious of the data structures involved it became much easier.
//
//What did you learn about manipulating objects in this challenge?
//
//I learned that one does not need to define variables or objects before adding them to objects - this can be accomplished on one line.
